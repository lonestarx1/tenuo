...
class TestGrant:
    ...
    def test_grant_to_dict(self):
        ...
        grant = Grant(
            skill="search",
            constraints={"url": {"type": "UrlSafe", "allow_domains": ["example.com"]}}
        )
        d = grant.to_dict()
    ...
    def test_grant_from_dict(self):
        ...
        data = {
            "skill": "fetch",
            "constraints": {"path": {"type": "Subpath", "root": "/data"}}
        }
...
class TestChainValidationErrors:
    ...
    def test_untrusted_issuer_with_reason(self):
        ...
        error = UntrustedIssuerError(
            "z6MkAttacker",
            reason="Root warrant issuer not trusted"
        )
        jsonrpc = error.to_jsonrpc_error()
...
class TestA2AInvariants:
    ...
    def test_invariant_audience_mismatch_error(self):
        ...
        error = AudienceMismatchError(
            expected="https://agent-a.com",
            actual="https://agent-b.com"
        )
...
class TestWireFormatInvariants:
    ...
    def test_grant_serialization_roundtrip(self):
        ...
        original = Grant(
            skill="search",
            constraints={
                "url": {"type": "UrlSafe", "allow_domains": ["example.com"]}
            }
        )
...
class TestWarrantValidationUnit:
    ...
    def server_for_validation(self):
        """Server configured for validation tests."""
        return A2AServer(
...
class TestSecurityEdgeCases:
    ...
    def test_subpath_url_encoded_traversal_note(self, server_with_constraints):
        ...
        try:
            ...
            result = server_with_constraints._check_constraint(
                constraint, "/data/%2e%2e/etc/passwd"
            )
            ...
            assert server_with_constraints._check_constraint(
                constraint, decoded_path
            ) is False  # This correctly blocks
        except ImportError:
            pytest.skip("tenuo_core not available")
    ...
    def test_urlsafe_ipv6_mapped_ipv4(self, server_with_constraints):
        ...
        try:
            ...
            result = server_with_constraints._check_constraint(
                constraint, "http://[::ffff:127.0.0.1]/"
            )
...
class TestWarrantJWTParsing:
    ...
    def test_warrant_with_constraints(self, test_keypair):
        ...
        try:
            from tenuo_core import Warrant, SigningKey, Pattern
        except ImportError:
            pytest.skip("tenuo_core not available")
