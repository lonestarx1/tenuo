...
class A2AClient:
    ...
    async def _get_client(self):
        ...
        if self._client is None:
            try:
                ...
                raise ImportError(
                    "httpx is required for A2A client. "
    ...
    async def send_task(
        ...
        *,
        ...
        if not hasattr(warrant, "to_base64"):
            raise TypeError(
                f"warrant must be a Warrant object with to_base64() method, "
    ...
    async def send_task_streaming(
        ...
        *,
        ...
        Note: Streaming support is Phase 2. This is a placeholder that
        falls back to non-streaming for MVP.
        """
        # MVP: Fall back to non-streaming
